...
void main() async {
  ...
  try {
    ...
    print('Similarity between "chronic kidney disease" and "kidney failure": $similarity');
...
class MockDgtlRagService {
  ...
  String _generateResponse(String query, List<Map<String, dynamic>> context) {
    ...
    final confidence = (primaryContext['similarity'] * 100).round();
    
    return '''
Based on clinical guidelines for $category (Confidence: $confidence%):
